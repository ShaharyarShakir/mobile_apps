        ...
        >
          ...
          >
            ...
            <Text style={[styles.navTitle, { color: colors.textPrimary }]}>
              {status === "completed" ? "Completed" : "Image Compression"}
            </Text>
          </Pressable>
        </View>
        ...
        {status === "idle" && (
          <View style={styles.idleContainer}>
            ...
            <View style={styles.actionBottom}>
              <PrimaryButton
                title={`Compress Now (${IMAGE_PRESET_DETAILS[preset].title})`}
                variant="accent"
            ...
            <View style={styles.resultsScroll}>
              <View style={styles.successHeader}>
                ...
                <View style={styles.successHeaderText}>
                  ...
                  >
                    {successfulCount} of {results.length} images processed
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.quickActionsRow}>
                <Pressable
                  ...
                  style={({ pressed }) => [
                    ...
                    {
                      backgroundColor: savedAll
                        ? colors.surfaceSubtle
                        : colors.accentSubtle,
                      borderColor: savedAll ? colors.border : colors.accent,
                      opacity: pressed ? 0.75 : 1,
                    },
                  ]}
                >
                  <Ionicons
                    name={savedAll ? "checkmark-done" : "download-outline"}
                    size={18}
                    color={savedAll ? colors.textPrimary : colors.accent}
                  />
                  <Text
                    style={[
                  ...
                  >
                    {savedAll ? "Saved to Photos" : "Save All to Photos"}
                  </Text>
                </Pressable>
